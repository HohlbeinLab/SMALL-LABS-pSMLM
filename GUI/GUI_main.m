...
SMALLLABS_main(handles.filepath.String{1,1},str2num(handles.dfrlmsz_edit.String),...
    ...
    'phasor_SP',handles.phasorSP_radiobtn.Value,...
    'phasor_SPcal',handles.phasor_SP_calib.String{1,1},...
    'phasor_TP',handles.phasorTP_radiobtn.Value,...
    'phasor_TPcal',handles.phasor_TP_calib.String{1,1},...
